...
/// <summary>
/// Ready-made choices for <see cref="OffsideApplicationInsightsOptions.FormatMessage"/>, the text
/// of the trace. Every format receives the error and its already-resolved message, so none of them
/// has to know about the catalog or the culture.
/// </summary>
/// <remarks>
/// This only shapes the trace text. The code, the kind, and the field always travel as dimensions
...
{
    /// <summary>
    /// The resolved message on its own — the default. Best when the traces land somewhere the
    /// dimensions are queryable, which is the case for Application Insights and Kusto.
    /// </summary>

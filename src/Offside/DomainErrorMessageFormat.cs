...
/// <summary>
/// Ready-made choices for the text of a recorded log or trace line. Every format receives the
/// error and its already-resolved message, so none of them has to know about the catalog or the
/// culture.
/// </summary>
/// <remarks>
/// This only shapes the line. The code, the kind, and the field always travel as dimensions

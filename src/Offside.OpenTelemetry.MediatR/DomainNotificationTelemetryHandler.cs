...
/// <summary>
/// Records every published <see cref="DomainNotification"/> through OpenTelemetry.
/// </summary>
/// <remarks>
/// Registered by <c>AddOffsideOpenTelemetryMediatR</c>. It runs alongside the collector

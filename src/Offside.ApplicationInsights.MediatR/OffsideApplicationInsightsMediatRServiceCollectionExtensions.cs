...
/// <summary>Registration entry point for the MediatR to Application Insights bridge.</summary>
public static class OffsideApplicationInsightsMediatRServiceCollectionExtensions
{
    ...
    /// <remarks>
    /// Call <c>AddOffsideApplicationInsights</c> for the recorder and configure MediatR in the
    /// host. This method registers neither.
    /// </remarks>
    ...
    public static IServiceCollection AddOffsideApplicationInsightsMediatR(this IServiceCollection services)
    {
        ...
        if (services.Any(descriptor =>
            descriptor.ServiceType == typeof(OffsideApplicationInsightsMediatRRegistrationMarker)))
        {
            return services;
        }

        services.AddSingleton<OffsideApplicationInsightsMediatRRegistrationMarker>();
...
internal sealed class OffsideApplicationInsightsMediatRRegistrationMarker;

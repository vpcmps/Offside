...
| `Offside.Testing` | [![NuGet](https://img.shields.io/nuget/v/Offside.Testing?label=%20&logo=nuget)](https://www.nuget.org/packages/Offside.Testing) | `netstandard2.0`, `net8.0`, `net10.0` | Asserções sobre `Result`, `Error` e catálogos, sem dependência de framework de teste |
| `Offside.Refit` | [![NuGet](https://img.shields.io/nuget/v/Offside.Refit?label=%20&logo=nuget)](https://www.nuget.org/packages/Offside.Refit) | `netstandard2.0`, `net8.0`, `net10.0` | Falhas do Refit vindas de API externa mapeadas para `Error` / `Result` |
| `Offside.ApplicationInsights` | [![NuGet](https://img.shields.io/nuget/v/Offside.ApplicationInsights?label=%20&logo=nuget)](https://www.nuget.org/packages/Offside.ApplicationInsights) | `netstandard2.0`, `net8.0`, `net10.0` | Erros de domínio registrados como traces do Application Insights |
| `Offside.ApplicationInsights.MediatR` | [![NuGet](https://img.shields.io/nuget/v/Offside.ApplicationInsights.MediatR?label=%20&logo=nuget)](https://www.nuget.org/packages/Offside.ApplicationInsights.MediatR) | `netstandard2.0`, `net8.0`, `net10.0` | Ponte que registra domain notifications publicadas como telemetria |
